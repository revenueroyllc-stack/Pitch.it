        ...
        return (
          ...
          >
            <div
              ...
              style={{ width: `${fill}%`, background: 'rgba(255,255,255,0.9)' }}
            />
          </button>
        );
      })}
...
function ControlBar({
  ...
  return (
    <div
      className={`flex items-center gap-3 px-5 py-4 transition-all duration-200 ease-out ${
        visible
    ...
    >
      <button
        ...
        style={locked ? { background: 'rgba(255,255,255,0.15)' } : undefined}
      ...
      <div className="w-px self-stretch" style={{ background: 'rgba(255,255,255,0.15)' }} aria-hidden="true" />
