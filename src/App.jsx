    ...
    <div className="shell">
      <header className="topbar">
        <div className="brand-wrap">
          ...
          <div className="brand-badge">{session ? 'Workspace' : 'Demo Preview'}</div>
        </div>
      ...
      {!session ? (
        <>
          <section className="auth-strip auth-strip-landing">
            <div className="auth-intro">
              <div className="card-title no-margin">Welcome</div>
              <h2>Practice calls before you go live.</h2>
              <p className="section-note">Sign in to unlock your private workspace, live transcript coaching, objection vault, and saved session replay. This screen is now a simple preview instead of the full app.</p>
            </div>

            <form className="auth-form auth-form-card" onSubmit={handleAuthSubmit}>
            ...
            <div className="status-line">
              <span>Demo preview only — nothing is stored until you sign in.</span>
              <span>{message}</span>
            </div>
          </section>
          ...
          <main className="content">
            <section className="landing-panel">
              <div className="landing-hero">
                <div className="card landing-copy">
                  <div className="card-title">After login</div>
                  <h1>One clean workspace for prep, live coaching, objections, and replay.</h1>
                  <p className="section-note">This quick cleanup makes the app feel more like a product: simple sign-in first, clear preview second, full workspace only after authentication.</p>
                  <div className="pill-grid hero-points">
                    <div className="signal-pill good">
                      <strong>Prep</strong>
                      <span>Set your objective, talking points, and objection responses.</span>
                    </div>
                    <div className="signal-pill good">
                      <strong>Live Coach</strong>
                      <span>Capture browser speech recognition and get coaching prompts.</span>
                    </div>
                    <div className="signal-pill good">
                      <strong>Replay</strong>
                      <span>Save snapshots to Supabase and review them later.</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="preview-steps">
                    <div className="preview-step">
                      ...
                      <div>
                        ...
                        <span>Use email and password to open your private workspace.</span>
                      </div>
                    </div>
                    <div className="preview-step">
                      <span className="tp-num">2</span>
                      <div>
                        <strong>Prep your call</strong>
                        <span>Add goals, talking points, and objection handling notes.</span>
                      </div>
                    </div>
                    <div className="preview-step">
                      ...
                      <div>
                        ...
                        <span>Start a live session, save snapshots, and replay what happened.</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="preview-grid">
                <article className="preview-card">
                  <div className="card-title">Prep Workspace</div>
                  <h3>Call objective and talking points</h3>
                  <p className="section-note">A focused setup screen instead of a wall of live data on first load.</p>
                </article>
                <article className="preview-card">
                  <div className="card-title">Live Coaching</div>
                  <h3>Transcript + coach feed</h3>
                  <p className="section-note">Start a session when you are ready, not the moment the app opens.</p>
                </article>
                <article className="preview-card">
                  <div className="card-title">Session Replay</div>
                  <h3>History that stays private</h3>
                  <p className="section-note">Saved snapshots stay tied to your account and load after sign-in.</p>
                </article>
              </div>
            </section>
          </main>
        ...
        <>
          <section className="auth-strip">
            <div className="signed-in-bar">
              <div>
                <div className="card-title no-margin">Workspace</div>
                <div className="user-pill">{session.user.email}</div>
              </div>
              <div className="wrap">
                <button className="btn btn-ghost" type="button" onClick={saveWorkspace} disabled={saving}>{saving ? 'Saving...' : 'Save workspace'}</button>
                <button className="btn btn-gold" type="button" onClick={saveSessionSnapshot} disabled={savingSession}>{savingSession ? 'Saving...' : 'Save session'}</button>
                <button className="btn btn-red" type="button" onClick={handleSignOut}>Sign out</button>
              </div>
            </div>
            <div className="status-line">
              <span>Signed in. Your private workspace and session history are available below.</span>
              <span>{message}</span>
            </div>
          </section>
                ...
                <div className="hero-grid">
                  <div className="ai-generate-section">
                    <div className="ai-generate-header">
                      ...
                      <span className="ai-tag">Ready</span>
                    </div>
                    ...
                    <p className="section-note">Use this workspace to set your objective, tighten your talking points, and prepare responses before you start the live coaching session.</p>
                  </div>
                ...
                <div className="live-layout">
                  <div className="live-left">
                    ...
                    <div className="controls-bar wrap">
                      ...
                      <button className="btn btn-gold" type="button" onClick={saveSessionSnapshot} disabled={savingSession}>{savingSession ? 'Saving...' : 'Save Snapshot'}</button>
                    </div>
                  </div>
                  ...
                  <div className="debrief-header">
                    ...
                    <div className="score-pill">
                      ...
                      <div className="score-info">
                        ...
                        <p>Replay saved sessions and refine the next call plan.</p>
                      </div>
                    </div>
                  </div>
